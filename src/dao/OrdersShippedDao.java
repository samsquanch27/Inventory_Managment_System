...
public class OrdersShippedDao {
	...
	private final static String  DISPLAY_ORDERS_QUERY = "select * from orders";
	...
	public static List<OrdersShippedDao> getOrders() throws SQLException{
		ResultSet rs = connection.prepareStatement( DISPLAY_ORDERS_QUERY).executeQuery();
	...
	private static OrdersShippedDao populateOrders(int id, String name) throws SQLException {
