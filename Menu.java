...
public class Menu {
	...
	private List<String> options = Arrays.asList( "Create purchase", "Delete purchase", "Show shipment", "Display orders");
	...
	private void displayOrders() throws SQLException {
		...
		for (OrdersShippedDao order : orders) {
			System.out.println(order.getOrders() + ": " + order.getOrderName());
		}
		
	private void displayInventory() throws SQLException {
		System.out.print("Enter Current Inventory Id:");
		int id = Integer.parseInt(scanner.nextLine());
		InventoryDao.displayInventory(id);
