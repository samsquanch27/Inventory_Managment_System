...
public class PurchasesDao {
		...
		public static Object getOrdersId(int id) {
			// TODO Auto-generated method stub
			return null;
		}
		
		public void displayInventory(int id) throws SQLException {
			PreparedStatement  ps = connection.prepareStatement(DISPLAY_CURRENT_INVENTORY_QUERY);
			ps.setInt(1, id);
			ps.executeUpdate();
			}
